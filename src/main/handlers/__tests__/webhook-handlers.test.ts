...
describe('webhook-handlers', () => {
  ...
  describe('webhook URL host validation', () => {
    ...
    it.each([
      ...
      ['http://93.184.216.34/hook', true, 'valid public IP'],
      ['https://localhost/hook', false, 'localhost'],
      ['https://127.0.0.1/hook', false, 'IPv4 loopback'],
      ['https://[::1]/hook', false, 'IPv6 loopback bracket notation'],
      ['http://[::1]/hook', false, 'IPv6 loopback http bracket notation'],
      ['http://::ffff:127.0.0.1/hook', false, 'IPv4-mapped IPv6 loopback'],
      ['http://[fc00::1]/hook', false, 'IPv6 ULA (fc prefix)'],
      ['http://[fe80::1]/hook', false, 'IPv6 link-local (fe80)'],
