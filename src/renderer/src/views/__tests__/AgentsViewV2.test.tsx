/**
 * AgentsViewV2 — covers the v2Agents=true path that ships by default.
...
// v2Agents=true — the production path under audit
vi.mock('../../stores/featureFlags', () => ({
  useFeatureFlags: vi.fn((selector: any) =>
    selector({ v2Shell: false, v2Dashboard: false, v2Pipeline: false, v2Agents: true })
  )
}))
...
describe('AgentsViewV2 (via AgentsView dispatcher)', () => {
  beforeEach(() => {
