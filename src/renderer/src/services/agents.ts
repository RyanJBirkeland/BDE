...
export async function listAgents(opts: Parameters<typeof window.api.agents.list>[0]) {
  return window.api.agents.list(opts)
}

export async function readAgentLog(params: Parameters<typeof window.api.agents.readLog>[0]) {
  return window.api.agents.readLog(params)
}

export async function importAgent(params: Parameters<typeof window.api.agents.import>[0]) {
...
export async function spawnLocal(args: Parameters<typeof window.api.agents.spawnLocal>[0]) {
  return window.api.agents.spawnLocal(args)
}

export function tailLog(params: Parameters<typeof window.api.agents.tailLog>[0]) {
