  ...
  return (
    ...
    >
      <div style={{ maxWidth: 560 }}>
        <h1 style={{ fontSize: 20, marginBottom: 12 }}>FLEET could not initialize</h1>
        ...
        <ol style={{ paddingLeft: 20, lineHeight: 1.7 }}>
          <li>Quit FLEET, then relaunch it by right-clicking the app and choosing Open.</li>
          <li>
            In Terminal, run{' '}
            <code
              style={{
          ...
          <li>If the problem persists, reinstall FLEET from the latest release.</li>
        </ol>
