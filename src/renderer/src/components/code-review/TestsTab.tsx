      ...
      >
        ...
        <div
          ...
          style={{
            ...
            padding: '2px 8px',
            borderRadius: 4,
            color: last.success ? 'var(--bde-accent)' : 'var(--neon-red, #ff5c5c)',
            border: `1px solid ${last.success ? 'var(--bde-accent-border, rgba(0,255,255,0.4))' : 'var(--neon-red-border, rgba(255,70,70,0.4))'}`,
