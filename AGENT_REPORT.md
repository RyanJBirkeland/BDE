...
3. **src/renderer/src/components/planner/__tests__/CreateEpicModal.test.tsx**
...
4. **src/renderer/src/components/planner/__tests__/EpicList.test.tsx** - 3 errors
   - Missing closing braces

5. **src/renderer/src/views/__tests__/SettingsView.test.tsx** - 1 error
