...
- **Why it matters:** The 5-type model implies the user should be able to choose; in practice the Agents view exposes 1.5 modes (assistant + templates that all become assistants). The Workbench is the *only* place to access the copilot/synthesizer flows.
