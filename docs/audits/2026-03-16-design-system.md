...
> **Snapshot: 2026-03-16 — SUPERSEDED. Token unification (DP-S1) and other Design Polish stories shipped (see `docs/specs/dp-s*.md`). Retained as historical reference.**
