...
> **Status: SHIPPED (verified 2026-04-21).** `TerminalView.tsx` is gone; terminal UI is fully componentized under `src/renderer/src/components/terminal/` and the IDE `TerminalPanel`. Retained for historical reference.
