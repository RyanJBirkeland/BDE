...
> **Status: SHIPPED / SUPERSEDED (verified 2026-04-21). The Sprint components originally referenced are gone. Current Sprint components (`SprintPipeline`, `TaskDetailDrawer`, etc.) ship their own `__tests__/` directories.**
