...
> **Status: SHIPPED (verified 2026-04-21). Types moved to `src/shared/types/`, backend selector exists at `src/main/agent-manager/backend-selector.ts`, and updateTask enforces the field allowlist.**
