...
> **Status: ABANDONED (verified 2026-04-21). `sprint:read-spec-file` channel never landed and SpecDrawer no longer exists. Retained for historical reference only.**
