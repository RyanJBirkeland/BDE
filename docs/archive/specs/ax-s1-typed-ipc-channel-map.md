...
> **Status: SHIPPED (verified 2026-04-21). `IpcChannelMap` is exported from `src/shared/ipc-channels/`, now split into domain-grouped modules with an `ipc-channels.ts` backward-compat shim.**
