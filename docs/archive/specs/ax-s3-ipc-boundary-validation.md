...
> **Status: SHIPPED (verified 2026-04-21). `src/main/fs.ts` uses `path.resolve` plus `validateMemoryPath`/`validateLogPath`/`validateSafePath`/`validateIdePathForAttachment`.**
