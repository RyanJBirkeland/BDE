...
> **Status: SUPERSEDED (verified 2026-04-21). Several referenced views are gone; `text-gradient` and aurora utility classes are in `design-system/utilities.css` and applied broadly.**
