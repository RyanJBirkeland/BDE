...
> **Status: SHIPPED / SUPERSEDED (verified 2026-04-21). TerminalView/CostView targets no longer exist; token-based color usage dominates the remaining code. Any residual hardcoded colors are smaller than a spec-scale effort.**
