...
> **Status: SHIPPED (verified 2026-04-21). `src/main/git.ts` uses `execFileAsync` exclusively. `local-agents.ts` was removed as part of the broader agent-manager rearchitecture.**
