...
> **Status: SHIPPED (verified 2026-04-21). `src/main/handlers/__tests__/` has wide coverage and `ipc-registration.test.ts` covers the main-process registration path.**
