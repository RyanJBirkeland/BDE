...
> **Status: SHIPPED (verified 2026-04-21). Store/hook/service coverage is substantially higher; several originally referenced files (`useUnifiedAgents`, `useTaskNotifications`) have been replaced but the replacements have tests.**
