...
> **Status: ABANDONED (verified 2026-04-21). LogDrawer + the life-os `task-runner` were replaced by the in-process agent manager. Retained for historical reference only.**
