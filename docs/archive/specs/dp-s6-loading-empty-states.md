...
> **Status: PARTIAL / OBSOLETE (verified 2026-04-21). References 5+ views (Sessions, Memory, Cost, ...) that no longer exist. Current views handle loading/empty states per-component. Retained for design-language reference.**
