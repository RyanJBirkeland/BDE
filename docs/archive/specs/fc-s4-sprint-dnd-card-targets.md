...
> **Status: ABANDONED (verified 2026-04-21). KanbanBoard / KanbanColumn / TaskCard no longer exist. Sprint Pipeline is a different UI paradigm. Retained for historical reference only.**
