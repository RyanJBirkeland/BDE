...
| `review.ts` | Thin IPC adapters for the Code Review Station — diff/commits/file queries, freshness/auto-review checks, and action handlers (`review:mergeLocally`, `review:createPr`, `review:requestRevision`, `review:discard`, `review:shipIt`, `review:shipBatch`, `review:rebase`). `review:shipBatch` validates every task id and delegates to `services/review-ship-batch.ts`. | `registerReviewHandlers`, `ReviewHandlersDeps` |
