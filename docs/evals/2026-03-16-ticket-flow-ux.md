...
> **Snapshot: 2026-03-16 — SUPERSEDED. Fed specs `docs/archive/specs/tf-s1/s2/s3` which were all ABANDONED (NewTicketModal replaced by Task Workbench). Retained for historical reference.**
