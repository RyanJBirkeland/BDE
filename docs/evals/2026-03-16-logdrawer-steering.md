...
> **Snapshot: 2026-03-16 — SUPERSEDED. Feed spec `docs/archive/specs/ld-s1-logdrawer-live-output-steering.md` was ABANDONED when the LogDrawer and life-os task-runner were removed. Retained for historical reference.**
